...
RUN install2.r rsconnect tidyverse shinydashboard shinyWidgets shinyjs shinycssloaders plotly DT magrittr renv markdown forcats svglite readxl haven gridExtra R2HTML
